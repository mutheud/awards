# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-01-09 07:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rate', to='awards.Project')),
        ...
        migrations.AddField(
            model_name='profile',
            name='rate',
            field=models.ManyToManyField(max_length=30, related_name='image', to='awards.Project'),
        ),
    ]
